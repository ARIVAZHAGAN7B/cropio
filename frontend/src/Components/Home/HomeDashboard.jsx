        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <p className="text-[#121b0e] text-[32px] font-bold leading-tight min-w-72">
                Welcome back, Ethan
              </p>
            </div>
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              {[
                ...
                <div
                  key={title}
                  className="flex flex-1 gap-3 rounded-lg border border-[#d7e7d0] bg-[#f9fcf8] p-4 items-center"
                >
                  <div className="text-[#121b0e]">{icon}</div>
                  <h2 className="text-[#121b0e] text-base font-bold leading-tight">
                    {title}
                  </h2>
                </div>
              ))}
